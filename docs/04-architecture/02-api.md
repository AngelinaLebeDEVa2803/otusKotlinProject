...
2.  **`GET /api/v1/filials/{id}`** - Получение информации о филиале

3.  **`GET /api/v1/filials`** - Получение списка всех филиалов

4.  **`PATCH /api/v1/filials/{id}`** - Обновление информации о филиале

5.  **`DELETE /api/v1/filials/{id}`** - Удаление филиала из базы
...
2.  **`GET /api/v1/buildings/{id}`** - Получение информации о здании

3.  **`GET /api/v1/buildings`** - Получение списка всех зданий в заданном филиале
    *   *Параметры:* `?filialId=001`

4.  **`PATCH /api/v1/buildings/{id}`** - Обновление информации о здании

5.  **`DELETE /api/v1/buildings/{id}`** - Удаление здания из базы
