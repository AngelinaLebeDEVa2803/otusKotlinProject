...
1.  **[ADR-001: Выбор архитектуры реального времени для отображения занятости мест](ADR/adr-001.md)**
...
2.  **[ADR-002: Стратегия интеграции с корпоративной системой аутентификации](ADR/adr-002.md)**
...
3.  **[ADR-003: Выбор технологии для интерактивной карты офиса](ADR/adr-003.md)**
...
4.  **[ADR-004: Подход к офлайн-работе и конфликтам бронирования](ADR/adr-004.md)**
...
5.  **[ADR-005: Стратегия синхронизации с календарями (Google Calendar, Outlook)](ADR/adr-005.md)**
...
6.  **[ADR-006: Выбор базы данных для хранения состояния бронирований](ADR/adr-006.md)**
